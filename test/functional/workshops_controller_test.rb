...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { description: @workshop.description, level: @workshop.level, title: @workshop.title, type: @workshop.type }
    end
  ...
  test "should update workshop" do
    put :update, id: @workshop, workshop: { description: @workshop.description, level: @workshop.level, title: @workshop.title, type: @workshop.type }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
